...
const EJERCICIOS = [
  ...
  { id: "gato-camello", nombre: "Gato–camello", categoria: "calentamiento", segundos: 40,
  ...
  { id: "wall-sit", nombre: "Sentadilla isométrica en pared", categoria: "fuerza", grupo: "piernas", segundos: 40,
    claves: ["Espalda pegada a la pared", "Muslos paralelos al suelo", "Peso en los talones"] },
  { id: "step-ups", nombre: "Step-ups en escalón", categoria: "fuerza", grupo: "piernas", segundos: 45,
  ...
  { id: "kneeling-kickbacks", nombre: "Patada de glúteo a cuatro patas", categoria: "fuerza", grupo: "piernas", segundos: 40,
  ...
  { id: "plancha-lateral", nombre: "Plancha lateral", categoria: "fuerza", grupo: "core", segundos: 40,
  ...
  { id: "dead-bug", nombre: "Dead bug", categoria: "fuerza", grupo: "core", segundos: 40,
    claves: ["Tumbado, brazos al cielo", "Baja brazo y pierna contrarios despacio", "Lumbar pegada al suelo"] },
  { id: "superman", nombre: "Superman", categoria: "fuerza", grupo: "core", segundos: 40,
  ...
  { id: "crunch", nombre: "Crunch", categoria: "fuerza", grupo: "core", segundos: 40,
  ...
  { id: "mountain-climbers", nombre: "Mountain climbers", categoria: "cardio", grupo: "cardio", segundos: 40,
    img: "assets/img/mountain-climbers.jpg",
    claves: ["Plancha alta", "Rodilla al pecho alternando", "Ritmo controlado, sin rebote"] },
  { id: "high-knees", nombre: "Rodillas altas en el sitio", categoria: "cardio", grupo: "cardio", segundos: 40,
